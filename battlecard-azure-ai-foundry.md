...
## 2. The Agent Service Has No HA/DR Availability SLA
...
## 3. Cost: Many Meters vs. One Shared-Compute Fee
...
## 4. Governance and the EU AI Act: Assessment vs. Inline Enforcement
...
## 7. For the Buyer: A Recent, Renamed Product vs. an 18-Year Platform
